...
PageSize.prototype.update = function () {
  ...
  var b =
    window.innerWidth && window.scrollMaxX
      ? window.innerWidth + window.scrollMaxX
      : e.body.scrollWidth > e.body.offsetWidth
        ? e.body.scrollWidth
        : e.body.offsetWidth;
  var c =
    window.innerHeight && window.scrollMaxY
      ? window.innerHeight + window.scrollMaxY
      : e.body.scrollHeight > e.body.offsetHeight
        ? e.body.scrollHeight
        : e.body.offsetHeight;
  ...
  Spica.Event = {
    ...
    run: function (a) {
      ...
      Spica.Browser.isGecko || Spica.Browser.isOpera
        ? this.register(window, "DOMContentLoaded", a)
        : this.register(window, "load", a);
    },
  };
...
function Lightbox(b) {
  ...
  a._expandable = false;
  a._expanded = false;
  a._funcs = { move: null, up: null, drag: null, wheel: null, dbl: null };
  a._level = 1;
  a._curpos = { x: 0, y: 0 };
  a._imgpos = { x: 0, y: 0 };
  a._minpos = { x: 0, y: 0 };
  ...
  a._timer = null;
  a._anim = { step: 0, w: 50, h: 50, a: 0, t: 0, f: b.animation, s: 0 };
  a._indicator = null;
  a._overall = null;
  a._openedset = null;
  a._prev = null;
...
Lightbox.prototype = {
  ...
  _genListFromLinks: function (h) {
    ...
    for (var g = 0; g < b.length; g++) {
      ...
      if (f.getAttribute("title")) {
        ...
        if (
          f.firstChild &&
          f.firstChild.getAttribute &&
          f.firstChild.getAttribute("title")
        ) {
  ...
  _set_photo_size: function () {
    ...
    var d = { w: i._page.win.w - 30, h: i._page.win.h - k };
    var h = { x: 15, y: 15 };
    var e = { p: 9, n: 9, y: 0 };
    if (!i._expanded) {
      var f = { w: i._imgs[i._open].w, h: i._imgs[i._open].h };
      if (f.w < 0) {
        f.w = i._img.width;
      }
      if (f.h < 0) {
  ...
  _show_overall: function (g) {
    ...
    if (g) {
      ...
      var f = 100;
      var e = { w: 0, h: 0, x: 0, y: 0 };
      var b = { w: 0, h: 0, x: 0, y: 0 };
      var h = { w: c._img.width, h: c._img.height };
      var d = { w: c._page.win.w - 30, h: c._page.win.h - 30 };
      var a = h.w;
      if (a < h.h) {
        a = h.h;
      }
  ...
  _run: function () {
    ...
    if (
      a._anim.step === 0 ||
      a._anim.w != a._img.width ||
      a._anim.h != a._img.height
    ) {
      a._doResizing();
    }
    if (a._anim.step === 1) {
